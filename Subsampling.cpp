...
//compile: g++ -std=c++11 -lboost_program_options -o Subsampling Subsampling.cpp
//run: ./Subsampling -c app_id site_id -o train -e csv -v 1 -n 4 -l 1000 -k 1 -i demo_50.txt
//./Subsampling -c id -o train -e csv -v 1 -n 8 -l 5000000 -k 3 -i train.csv -p 15 -t test
